...
export function ExpandableAnswerText({
  ...
  function powerSelectedText() {
    ...
    if (!selection || !selectedText || !paragraph || !paragraph.contains(selection.anchorNode) || !paragraph.contains(selection.focusNode)) {
      setPoweredSelection("");
      return;
    }
  ...
  return (
    <>
      <p
        ...
        className={`text-[15px] leading-7 transition ${poweredSelection ? "rounded bg-skywash/35 shadow-[0_0_0_3px_rgba(141,166,139,0.16)]" : ""}`}
